...
def countries_list(request):
    if request.method=='GET':
        ...
        return JsonResponse(CountriesSerializer.errors,status=status.HTTP_400_BAD_REQUEST) 
...
def countries_detail(request,pk):
    ...
    if request.method=='GET':
        ...
        countries.delete()
        return JsonResponse({'message':'Country was deleted successfully'},status=status.HTTP_400_BAD_REQUEST)
